      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="px-4 py-2 bg-red-600/20 border border-red-600/30 rounded-full text-red-500 text-sm font-semibold tracking-wide inline-block mb-6">
              GET IN TOUCH
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Visit */}
            <div className="group bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-800 hover:border-red-600/50 transition-all duration-300 hover:shadow-2xl hover:shadow-red-600/20 hover:-translate-y-2">
